...
public class TestAttack3Spell extends AbstractSpell {

    private static final SpellBlueprint BLUEPRINT = SpellBlueprint.builder("test_attack_3")
            .icon(new ResourceLocation(Tags.MOD_ID, "textures/spell_icons/2.png"))
            .cooldown(10)
            .build();

    public TestAttack3Spell() {
        super(BLUEPRINT);
    }
