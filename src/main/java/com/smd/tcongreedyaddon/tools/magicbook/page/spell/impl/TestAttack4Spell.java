...
public class TestAttack4Spell extends AbstractSpell {

    private static final SpellBlueprint BLUEPRINT = SpellBlueprint.builder("test_attack_4")
            .icon(new ResourceLocation(Tags.MOD_ID, "textures/spell_icons/5.png"))
            .cooldown(40)
            .build();

    public TestAttack4Spell() {
        super(BLUEPRINT);
    }
